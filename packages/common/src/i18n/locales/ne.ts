...
export const ne: PosMessages = {
  ...
  "order.summary.status": "स्थिति: {status}",
  "order.summary.items": "वस्तुहरू: {count}",
  "admin.title": "Nukes POS व्यवस्थापन",
  "admin.nav.dashboard": "ड्यासबोर्ड",
  "admin.nav.orders": "अर्डरहरू",
  "admin.dashboard.welcome": "तपाईंको POS मा स्वागत छ।",
  "admin.orders.empty": "अहिलेसम्म कुनै अर्डर छैन।",
