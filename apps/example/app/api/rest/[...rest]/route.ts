import { createOpenApiHandlers } from "@nukesai-pos/backend/next";
...
export const { GET, POST, PUT, PATCH, DELETE } = createOpenApiHandlers(appRouter, {
